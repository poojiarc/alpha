    ...
    <footer className="bg-secondary border-t border-border">
      <div className="container-main px-4 md:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          {/* Brand Section */}
          <div>
            <div className="w-40 md:w-48 mb-4">
              <img
                src={logo}
          ...
          <div>
            ...
            <div className="flex flex-col gap-3 text-sm">
              ...
              <a
                href="https://www.linkedin.com/in/petahemanthprasad999"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-2 text-muted-foreground hover:text-primary transition-colors"
              >
              ...
              <a
                href="https://youtube.com/@petahemanthprasad"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-2 text-muted-foreground hover:text-primary transition-colors"
              >
              ...
              <a
                href="https://www.facebook.com/share/1ahqdQVk26/"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-2 text-muted-foreground hover:text-primary transition-colors"
              >
